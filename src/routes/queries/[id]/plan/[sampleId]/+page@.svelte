<script lang="ts">
	...
	import type { GetStatementSamplePlanResponse } from '@buf/pgdozor_backend.bufbuild_es/pgdozor/v1/statement_pb';
...
<div class="h-screen w-screen bg-paper text-ink">
	...
	{:else}
		<div class="flex h-full items-center justify-center font-mono text-[13px] text-ink/45">
